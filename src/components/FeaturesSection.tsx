...
export default function FeaturesSection() {
  ...
  return (
    ...
    >
      <GlassCard hover={false} glow="cyan" className="relative overflow-hidden p-8 sm:p-10">
        <div className="pointer-events-none absolute inset-0">
          ...
          >
            <svg viewBox="0 0 200 200" className="h-full w-full" fill="none">
              <g data-gsap="orbital">
                <circle cx="100" cy="100" r="72" stroke="rgba(56,189,248,0.25)" strokeWidth="1.5" />
                <circle cx="100" cy="100" r="52" stroke="rgba(14,165,233,0.2)" strokeWidth="1.5" />
                <path
                  data-gsap="trace"
                  d="M28 104c20-38 61-64 108-64"
              ...
              <circle cx="100" cy="28" r="5" fill="rgba(251,191,36,0.7)" />
              <circle cx="154" cy="122" r="6" fill="rgba(56,189,248,0.7)" />
            </svg>
          </div>
          <div
            data-gsap="pulse"
          ...
          <div
            data-gsap="float"
            className="absolute bottom-10 right-10 hidden h-28 w-28 opacity-80 md:block"
          >
            <svg viewBox="0 0 160 160" className="h-full w-full" fill="none">
              <rect x="12" y="12" width="136" height="136" rx="24" stroke="rgba(248,113,113,0.25)" />
              <path
                d="M28 96c18-28 48-44 78-44 18 0 33 4 44 12"
                ...
                data-gsap="trace"
              />
              <circle cx="44" cy="44" r="8" fill="rgba(236,72,153,0.45)" />
            </svg>
          </div>
        </div>
